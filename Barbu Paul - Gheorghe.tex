...
Pentru ca fiecare funcție și variabilă din cod să primească o adresă, linker-ul folosește un script de linking pentru a ști în ce zone este împărțit codul și ce mărime au aceste zone.

TODO: despre zone, in mare, BSS, const, text, data, etc, ram
TODO: arata exemplu default de .ld si explica-l
TODO: arata exemplu .ld modificat cu marimea bootloader-ului
TODO: spune ca aceasta marime a variat si ea s-a asezat doar dupa ce codul s-a stabilizat

TODO: schema cu memoria, dreptunghi.
TODO: relativ la cheile de criptare, spune cum vor fi ele scrise si de ce necesita o zona separata de memorie
