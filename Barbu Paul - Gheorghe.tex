...
With this I have arrived at an initial model that looks like this: $ ARIMA(1, 0, 0)(1, 0, 0) $. That is, a first order non-seasonal and seasonal auto-regressive ARIMA model with no differences and no moving average.

Now I shall see how this model behaves and if it captures all the information in the data.

Present results fro this model, then show how fourier and dummies improve it, directly on the full 2hrs ph3 data.
...
Summary of time-series (15 of them, as line sin table) and models chosen.
