...
The next two sets of results deal with the $PV1 $ and $ PV2 $ data series. These represent the electrical energy production of a household that has two photo-voltaic panels installed.
...
Though not mathematically exact, and not always based on statistical tests (as noted in the previous section) the results of the work do seem to be reasonable and further usable to predict electrical energy consumption and production. The results are comparable with other methods applied on the same data set and even better then the artificial neural networks approach.
