...
Spațiul de 8 KB va fi plasat în continuarea bootloader-ului, deci începând cu adresa \texttt{0x8000}, aceasta fiind limita până la care poate ajunge bootloader-ul. Așadar spațiul total ocupat de bootloader și cel auxiliar, rezervat pentru cheile de criptare este de 40 KB.

TODO: scriptul aplicației, ca acolo se vede spațiul rezervat pt. chei
TODO: schema cu memoria, tabel, vezi doc SVN.
...
TODO: despre JTAG, stergerea flash-ului, tehnologii de flash, el de fapt este pe 1 si cand scriem se duce pe 0
TODO: memory map, cum sta bootloader-ul si aplicatia guest in memorie

TODO: encryptie end-to-end




%TODO: memory map + size + printf, user guide & features, architecture
% ---- 
...
%TODO: ??? AES implemenatre fara tabele (memorie vs viteza)
