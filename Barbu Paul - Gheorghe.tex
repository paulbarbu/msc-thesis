...
Of course not all time-series are random ones, so in order to be able to use them with ARIMA there has to be applied a kind of transformation. This is the topic of sections \ref{differencing} and \ref{boxcoxtransformation}, making non-stationary data, stationary.
