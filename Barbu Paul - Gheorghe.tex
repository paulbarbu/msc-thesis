...
Înainte de a arăta cum anume funcționează bootloader-ul din punct de vedere al utilizatorului, al clientului vom re-itera cum funcționează procesul de încărcare a unei aplicații pe un microcontroller fără bootloader.
