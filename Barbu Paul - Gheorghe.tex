...
%TODO: expand on R and the ARIMA packges?

\section{Seasonal data}
In what is left of this chapter, I am going to explain each concept, that I have used in understanding the ARIMA model and its variations, both in isolation and in relation to the model and its role in choosing the best ARIMA model.
