...
What follows are some tables that provide the main results for each of the time series, together with their down-sampled versions.
...
All the following tables will have the very same format and meanings for the columns, namely:
\begin{itemize}
    ...
    \item \textbf{Running time}: measured in seconds, shows how long the completion of the forecasting took on this data using the current model;
...
The plot for the predicted data can be seen in figure \ref{dbestph1}.
    
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{dbestph1}
    \caption{prediction by the best model on the \texttt{P1} data}
    \label{dbestph1}
\end{figure}

%TODO: tables with results and attached plots for the full data on the best model
%TODO: Summary of time-series (more 15 of them, as line sin table) and models chosen, time to run, train/test days, fourier, dummies, and how many models are best for a given time series.

%TODO: errors vs values, as difference in magnitude
%TODO -Which are the main results of your paper and application areas ?

%TODO How many train days and test days are best to forecast?

%TODO: mean, naive explanations and the magnitute of errors

%TODO: compare with other methods (NN and markov)
