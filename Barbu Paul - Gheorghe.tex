...
Înainte să putem trimite o aplicație spre microcontroller folosind Flasher-ul, trebuie să avem în vedere că pe lângă aplicația în sine ...
TODO: trebuie criptata + IV + TAG -> format de fisier -> bundler


TODO: reitereaza ce are clientul (flasher + app criptata), ce face dezvoltatorul (flash bootloader, bundle app), ce face clientul (run flasher), si ce se intampla la final (bootloader + app)
