...
Since ARIMA is invertible (look for citation) ACF swaps places with PACF for determining MA(q).

Say something about SAR(P) and SMA(Q). Use \ref{usgdpacfpacf} as an example.
...
\subsection{QQ plots}
%TODO:space: more subsections as needed from the Rmd
