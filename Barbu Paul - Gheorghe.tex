...
\begin{figure}[h]
    ...
    \caption{goog200: Google stock price for 200 consecutive days; strikes: Annual number of strikes in the US; elec: Monthly Australian electricity production; beer: Monthly Australian beer production; eggs: Annual price of a dozen eggs in the US (constant dollars); hsales: Monthly sales of new one-family houses sold in the US; pigs: Monthly total of pigs slaughtered in Victoria, Australia }
...
\begin{figure}[h]
    ...
    \caption{goog200: Google stock price for 200 consecutive days; goog200': first difference of goog200 data }
    \label{ddiffgoog200}
\end{figure}
...
%TODO: usmelec example from \cite{fpp2stationarity}
...
%TODO: ACF used to see non-stationarity since all values are highly correlated between them, this is how the ADF test works at an intuitive level as well.
One of the ways for identifying stationary or non-stationary time series is by using the Autocorrelation function plot. This plot will drop to zero pretty quickly for a stationary time series, while on the other hand the ACF of non-stationary time series will decrease very slowly \cite{fpp2stationarity}.
%TODO: acf(goog200) and acf(diff(goog200)) \cite{fpp2stationarity} examples. as well as euretail from \cite{fpp2seasonalarima}

Say that AR is a bit of differencing (R. Nau citation)
...
Say that MA is a bit of removing differencing (R. Nau citation)
